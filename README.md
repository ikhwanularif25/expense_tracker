...
# Widget yang dipakai ulang (Reusable UI) ├── constants/ 
# Tema, warna, gaya teks ├── features/ 
# Fitur utama aplikasi │ ├── dashboard/ 
# UI ringkasan & home │ ├── transactions/ 
# CRUD transaksi & repository │ └── reports/ 
# Visualisasi chart ├── routing/ 
# Konfigurasi navigasi (GoRouter) └── services/ 
# Layanan global (Database Drift)
